...
DataFlow Express for full audit trail.
"""
...
class ApprovalQueueService:
    ...
    def expire_stale(self, max_age_hours: int = 24) -> int:
        ...
        records = self._db.express_sync.list("AgenticDecision", {"status": "pending"}, limit=10000)
    ...
    def list_pending(self, urgency: str | None = None) -> list[dict[str, Any]]:
        ...
        return self._db.express_sync.list("AgenticDecision", filter_params, limit=1000)
    ...
    def _resolve(
        ...
        # Read current state
        record = self._db.express_sync.read("AgenticDecision", decision_id)
