...
- Ed25519 (opt-in, asymmetric) — uses the same Ed25519 primitives as
  care_platform.trust.constraint.signing for consistency across the platform.
"""
...
def _ed25519_sign(private_key_bytes: bytes, content_hash: str) -> str:
    ...
    Reuses the same Ed25519 primitives as care_platform.trust.constraint.signing
