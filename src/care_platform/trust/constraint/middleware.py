...
from care_platform.trust.constraint.circuit_breaker import CircuitBreaker, CircuitBreakerOpen
...
if TYPE_CHECKING:
    ...
    from care_platform.trust.store.health import TrustStoreHealthCheck
...
class ApprovalRequest(BaseModel):
    ...
    .. deprecated::
        Use care_platform.use.execution.approval.PendingAction with a shared
