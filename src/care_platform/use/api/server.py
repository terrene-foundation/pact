...
Usage:
    python -m care_platform.use.api.server
"""
...
from care_platform.build.config.env import EnvConfig, load_env_config
...
from care_platform.use.api.events import event_bus
...
def create_app(
    ...
    def _get_firebase_verify():  # noqa: ANN202
        ...
        if _firebase_verify is None:
            try:
                from care_platform.trust.auth.firebase_admin import verify_firebase_id_token
