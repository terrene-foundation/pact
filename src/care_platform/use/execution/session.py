...
A PlatformSession represents a period of active work. Sessions contain
...
class SessionManager:
    ...
    def __init__(self) -> None:
        ...
        self._current: PlatformSession | None = None

    def start_session(self) -> PlatformSession:
        """Start a new session, ending any currently active session.

        Returns:
            The newly created active PlatformSession.
        """
    ...
    def end_session(self, notes: str = "") -> PlatformSession:
    ...
    @property
    def current_session(self) -> PlatformSession | None:
