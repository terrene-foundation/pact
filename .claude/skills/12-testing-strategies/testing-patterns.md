...
> Category: `testing`
> Priority: `HIGH`
> Policy: real infrastructure in Tiers 2-3
...
<!-- Trigger Keywords: test patterns, unit test example, integration test example, E2E test example, pytest patterns, testing fixtures, test timeout, real infrastructure -->
