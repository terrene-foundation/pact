...
**Testing**: All patterns use 3-tier strategy (Unit → Ollama → OpenAI), real infrastructure in Tiers 2-3
...
- **Test Fixtures**: `kailash-kaizen package: tests/conftest.py`
...
- ❌ Skip real infrastructure testing (real infrastructure in Tiers 2-3)
