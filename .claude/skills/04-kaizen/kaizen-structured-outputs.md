...
- [Kaizen BaseAgent Architecture](../../kailash-kaizen package: docs/guides/baseagent-architecture.md)
- [Signature Programming Guide](../../kailash-kaizen package: docs/guides/signature-programming.md)
- [OpenAI Structured Outputs Documentation](https://platform.openai.com/docs/guides/structured-outputs)
- [Kaizen Configuration Guide](../../kailash-kaizen package: docs/reference/configuration.md)
