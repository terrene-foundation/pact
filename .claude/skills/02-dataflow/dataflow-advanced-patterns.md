...
As of v0.11.0, `auto_migrate=True` (default) works correctly everywhere including Docker and FastAPI with synchronous DDL support. No startup tradeoffs.
...
| Models | Time | Notes                       |
| ------ | ---- | --------------------------- |
| 1-3    | <2s  | synchronous DDL handles DDL |
| 5      | <3s  | Scales well                 |
| 10     | <5s  | Still fast                  |
