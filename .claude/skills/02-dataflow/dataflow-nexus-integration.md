...
- **DataFlow v0.10.15**: `auto_migrate=True` (default) works in Docker/FastAPI with synchronous DDL support
...
- Use `auto_migrate=True` (default) - works in Docker/FastAPI with synchronous DDL support
