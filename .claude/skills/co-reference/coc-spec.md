...
Observation-Instinct-Evolution pipeline. JSONL logs → pattern analysis (confidence scoring) → suggest evolved artifacts (Skills >=0.7, Commands >=0.6, Agents >=0.8). All require human approval.
